...
## Overview of [Heuristic Evaluations](https://www.nngroup.com/articles/how-to-conduct-a-heuristic-evaluation/)
### 1. Visibility of System Status
Provide the user with information about what is happening with their interactions with the website
### 2. Match Between the System and Real World
Create designs and interactions that are relevant to us and mimics what we already know from reality
...
|---|---|---|---|---|
|1. Visibility of System Status: Provide the user with information about what is happening with their interactions on the website.| ![Heuristic1](LNRHeuristic1.png)|The website has features which shows how the user can interact with the website, as well as what is currently going on within the website. For example, the home page features a slideshow, which shows the user which picture it is currently on (with the green dot), how many pictures are left in the slideshow, and an indicator on the picture they are hovering over.|For this slideshow feature, I would recommend the website provide an indicator that also showcases how much time was allocated for each picture on the slideshow when it is playing. This way, the user would know when to expect the next image to pop up.|1|
|2. Match Between the System and Real World: Create designs and interactions that are relevant to us and mimics what we already know from reality. | ![Heuristic2 Drop Down Menu](LNRHeuristic21.png) ![Heuristic2 Opened Drop Down Menu](LNRHeuristic22.png) |
